  ...
  describe "Validation" do
    ...
    describe "edge cases" do
      ...
      it "won't make Customer instance with nil inputs" do
        ...
        expected_keys = [:name, :email, :address, :city, :state, :zip, :cc_company, :cc_name, :cc, :cc_exp_month, :cc_exp_year, :cvv]
      ...
      it "won't make Customer instance with various bad emails" do
        ...
        bad_emails.each do |bad_email|
          bad_customer = Customer.new(name:"ok", email: bad_email, address: "ok", city: "ok", state: "ok", zip: 123, cc_company: "ok", cc_name: "ok", cc: 123, cc_exp_month: "ok", cc_exp_year: "ok", cvv: 123)
